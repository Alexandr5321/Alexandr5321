...
START_TEST(less_or_equal_8) {
  s21_decimal dec1 = decimal_from_string("-34534553434.232446543232446543");
  s21_decimal dec2 = decimal_from_string("34534553434.232446543232446543");
  int res = s21_is_less_or_equal(dec1, dec2);
  ck_assert_int_eq(res, TRUE);
}
END_TEST
...
START_TEST(less_or_equal_9) {
  s21_decimal dec1 = decimal_from_string("1.78");
  s21_decimal dec2 = decimal_from_string("1.39");
  int res = s21_is_less_or_equal(dec1, dec2);
  ck_assert_int_eq(res, FALSE);
}
...
START_TEST(less_or_equal_10) {
  s21_decimal dec1 = decimal_from_string("-3453453452.0");
  s21_decimal dec2 = decimal_from_string("-34.0");
  int res = s21_is_less_or_equal(dec1, dec2);
  ck_assert_int_eq(res, TRUE);
}
END_TEST
...
START_TEST(less_or_equal_11) {
  s21_decimal dec1 = decimal_from_string("104235454634.34534534");
  s21_decimal dec2 = decimal_from_string("1042354546.34534534");
  int res = s21_is_less_or_equal(dec1, dec2);
  ck_assert_int_eq(res, FALSE);
}
END_TEST
...
START_TEST(less_or_equal_12) {
  s21_decimal dec1 = decimal_from_string("1042354546.34534534");
  s21_decimal dec2 = decimal_from_string("104235454634.345345");
  int res = s21_is_less_or_equal(dec1, dec2);
  ck_assert_int_eq(res, TRUE);
}
END_TEST
...
START_TEST(less_or_equal_13) {
  s21_decimal dec1 = decimal_from_string("1042.5667777");
  s21_decimal dec2 = decimal_from_string("1042.345345");
  int res = s21_is_less_or_equal(dec1, dec2);
  ck_assert_int_eq(res, FALSE);
}
END_TEST
...
START_TEST(less_or_equal_20) {
  s21_decimal dec1 = decimal_from_string("10");
  s21_decimal dec2 = decimal_from_string("3");
  int res = s21_is_less_or_equal(dec1, dec2);
  ck_assert_int_eq(res, FALSE);
}
...
START_TEST(less_or_equal_21) {
  s21_decimal dec1 = decimal_from_string("104232346.34534534");
  s21_decimal dec2 = decimal_from_string("3.3453453234");
  int res = s21_is_less_or_equal(dec1, dec2);
  ck_assert_int_eq(res, FALSE);
}
END_TEST
...
START_TEST(less_or_equal_22) {
  s21_decimal dec1 = decimal_from_string("-3.34534534");
  s21_decimal dec2 = decimal_from_string("3.34534534");
  int res = s21_is_less_or_equal(dec1, dec2);
  ck_assert_int_eq(res, TRUE);
}
END_TEST
...
Suite *suite_less_equal(void) {
  ...
  TCase *tc = tcase_create("less_equal_tcase");
