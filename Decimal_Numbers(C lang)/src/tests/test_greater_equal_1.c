...
START_TEST(greater_or_equal_1) {
  // float num1 = 1.375323;
  // float num2 = 1.39;
  s21_decimal dec1 = decimal_from_string("1.375323");
...
START_TEST(greater_or_equal_2) {
  ...
  s21_decimal dec1 = decimal_from_string("2");
  s21_decimal dec2 = decimal_from_string("1");
  int res = s21_is_greater_or_equal(dec1, dec2);
...
START_TEST(greater_or_equal_8) {
  ...
  // s21_from_float_to_decimal(num1, &dec1);
  // s21_from_float_to_decimal(num2, &dec2);
  s21_decimal dec1 = decimal_from_string("10423546.34534534");
...
START_TEST(greater_or_equal_10) {
  ...
  // s21_from_float_to_decimal(num1, &dec1);
  // s21_from_float_to_decimal(num2, &dec2);
  s21_decimal dec1 = decimal_from_string("1042634.34534534");
  s21_decimal dec2 = decimal_from_string("10424546.34534534");
  int res = s21_is_greater_or_equal(dec1, dec2);
  ck_assert_int_eq(res, FALSE);
}
END_TEST
...
START_TEST(greater_or_equal_11) {
  ...
  // s21_from_float_to_decimal(num1, &dec1);
  // s21_from_float_to_decimal(num2, &dec2);
  s21_decimal dec1 = decimal_from_string("10426.34534534");
  s21_decimal dec2 = decimal_from_string("104234.345345");
  int res = s21_is_greater_or_equal(dec1, dec2);
  ck_assert_int_eq(res, FALSE);
}
END_TEST
...
Suite *suite_greater_equal(void) {
  ...
  TCase *tc = tcase_create("greater_equal_tcase");
