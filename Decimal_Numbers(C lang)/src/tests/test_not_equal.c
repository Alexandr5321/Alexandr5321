...
START_TEST(not_equal_test_1) {
  ...
  ck_assert_int_eq(0, s21_is_not_equal(t1, t2));
}
END_TEST
...
START_TEST(not_equal_test_4) {
  ...
  ck_assert_int_eq(1, s21_is_not_equal(w1, w2));
}
END_TEST
...
START_TEST(not_equal_test_5) {
  ...
  ck_assert_int_eq(1, s21_is_not_equal(r1, r2));
}
END_TEST
...
START_TEST(not_equal_test_6) {
  ...
  set_scale(&n1, 10);
  set_scale(&n2, 11);
  ck_assert_int_eq(1, s21_is_not_equal(n1, n2));
}
END_TEST
...
START_TEST(not_equal_test_8) {
  s21_decimal r1 = {{0x00000001, 0x00000000, 0x00000000, 0x80000000}};
  s21_decimal r2 = {{0x00000001, 0x00000000, 0x00000000, 0x80000000}};
  ck_assert_int_eq(0, s21_is_not_equal(r1, r2));
}
END_TEST

START_TEST(not_equal_test_9) {
...
Suite *suite_not_equal(void) {
  Suite *s1 = suite_create("not_equal_suite");
  TCase *tc1_1 = tcase_create("not_equal_tcase");

  suite_add_tcase(s1, tc1_1);
  tcase_add_test(tc1_1, not_equal_test_1);
  tcase_add_test(tc1_1, not_equal_test_2);
  tcase_add_test(tc1_1, not_equal_test_3);
  tcase_add_test(tc1_1, not_equal_test_4);
  tcase_add_test(tc1_1, not_equal_test_5);
  tcase_add_test(tc1_1, not_equal_test_6);
  tcase_add_test(tc1_1, not_equal_test_7);
  tcase_add_test(tc1_1, not_equal_test_8);
  tcase_add_test(tc1_1, not_equal_test_9);
