...
START_TEST(greater_8) {
  ...
  // s21_from_float_to_decimal(num1, &dec1);
  // s21_from_float_to_decimal(num2, &dec2);
  s21_decimal dec1 = decimal_from_string("-3.232446546");
  s21_decimal dec2 = decimal_from_string("-3.2");
  int res = s21_is_greater(dec1, dec2);
  ck_assert_int_eq(res, FALSE);
}
END_TEST
...
START_TEST(greater_9) {
  ...
  // s21_from_float_to_decimal(num1, &dec1);
  // s21_from_float_to_decimal(num2, &dec2);
  s21_decimal dec1 = decimal_from_string("-345.232446546;");
  s21_decimal dec2 = decimal_from_string("-3.2");
  int res = s21_is_greater(dec1, dec2);
  ck_assert_int_eq(res, FALSE);
}
...
START_TEST(greater_10) {
  ...
  // s21_from_float_to_decimal(num1, &dec1);
  // s21_from_float_to_decimal(num2, &dec2);
  s21_decimal dec1 = decimal_from_string("-3.232323233232323233");
  s21_decimal dec2 = decimal_from_string("-34545124.232446543232446543");
  int res = s21_is_greater(dec1, dec2);
...
Suite *suite_greater(void) {
  ...
  tcase_add_test(tc1_1, s21_test_is_greater_1);
  tcase_add_test(tc1_1, s21_test_is_greater_2);
  tcase_add_test(tc1_1, s21_test_is_greater_3);
  tcase_add_test(tc1_1, s21_test_is_greater_4);
  tcase_add_test(tc1_1, s21_test_is_greater_5);
  tcase_add_test(tc1_1, s21_test_is_greater_6);
  tcase_add_test(tc1_1, s21_test_is_greater_7);
  tcase_add_test(tc1_1, s21_test_is_greater_8);
  tcase_add_test(tc1_1, s21_test_is_greater_9);
  tcase_add_test(tc1_1, s21_test_is_greater_10);
  tcase_add_test(tc1_1, s21_test_is_greater_51);
  tcase_add_test(tc1_1, s21_test_is_greater_41);
  tcase_add_test(tc1_1, s21_test_is_greater_2i);
